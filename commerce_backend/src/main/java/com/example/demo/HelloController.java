package com.example.commercebackend;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for commercebackend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to commercebackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: commercebackend";
    }
} 